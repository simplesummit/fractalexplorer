/* color.h -- header file exposing the common color utilities
...
// colorizes scanline across horiziontally
void scanline(unsigned char * out, int w,int h);

// make sure memory is allocated in col, specifically 4 * col.num bytes
